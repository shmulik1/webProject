...
//app = http.createapp(function (req, res) {
...
function displayForm(req, res) {
	...
	if(pathname == "/") {
		...
		fs.readFile('public/images/logo.jpg', function (err, data) {
			res.writeHead(200, {
				'Content-Type': 'text/javascript',
					'Content-Length': data.length
			});
	...
	else if (pathname == "/images/2.jpg") {
		fs.readFile('public/images/2.jpg', function (err, data) {
			res.writeHead(200, {
				'Content-Type': 'text/javascript',
					'Content-Length': data.length
			});
	...
	else if (pathname == "/images/3.jpg") {
		fs.readFile('public/images/3.jpg', function (err, data) {
			res.writeHead(200, {
				'Content-Type': 'text/javascript',
					'Content-Length': data.length
			});
